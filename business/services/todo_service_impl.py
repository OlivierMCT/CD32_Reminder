...
from business.models.todo import Todo, TodoUpdate, TodoNew, TodoStatus
...
class TodoServiceImpl(TodoService):
    ...
    def to_todo_from_entity(self, entity: TodoEntity) -> Todo:
        return Todo(
            id=entity.todo_id,
    ...
    def calculate_is_deletable(self, entity: TodoEntity) -> bool:
        return entity.is_done and entity.due_date < datetime.today()

    def calculate_status(self, entity: TodoEntity) -> TodoStatus:
        if entity.is_done:
